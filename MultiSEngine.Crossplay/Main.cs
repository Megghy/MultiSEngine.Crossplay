...
{
    public class Main : MSEPlugin
    {
        public override string Name => "MultiSEngine.Crossplay";
        public override string Description => "简单的跨版本";
        ...
        private static string Convert(int version)
        {
        ...
        public void OnJoin(Hooks.PlayerJoinEventArgs args)
        {
            ...
            {
                args.Handled = true;
                Logs.Info($"[Crossplay] {args.Client.Name} from {Convert(num)}, modifing packet.");
